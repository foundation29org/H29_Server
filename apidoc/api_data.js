define({ "api": [
  {
    ...
    "version": "1.0.0",
    "group": "Access_token",
    "description": "<p>This method gets the token and the language for the user. This token includes the encrypt id of the user, token expiration date, role, and the group to which it belongs. The token are encoded using <a href=\"https://en.wikipedia.org/wiki/JSON_Web_Token\" target=\"_blank\">jwt</a> <br> <br> The functionality of this method is directly related to the second authentication factor. That is, you have to take into account if the user you want to perform the operation with belongs or not to a patient group that has configured the 2FA.According to this, the answers obtained will be different. In this case, you will have to use the methods: <a href=\"#api-SignIn_2FA-Request_approval\">requestApproval</a> and <a href=\"#api-SignIn_2FA-Update_phone\">updatePhone</a>. At the moment the only patient group that has the functionality of 2FA implemented is Duchenne Parent Project Netherlands. <br> <br> We use the <a href=\"https://www.npmjs.com/package/fingerprintjs2\" target=\"_blank\">fingerprintjs2 library</a> for configuring the params.</p>",
    "examples": [
      {
  ...
  {
    "type": "get",
    "url": "https://health29.org/api/group/proms/:groupName",
    ...
    "examples": [
      {
        "title": "Example usage:",
        "content": "this.http.get('https://health29.org/api/group/proms/'+groupName)\n .subscribe( (res : any) => {\n   console.log('proms: '+ res);\n  }, (err) => {\n   ...\n  }",
        "type": "js"
      }
    ],
    "header": {
  ...
  {
    "type": "get",
    "url": "https://health29.org/api/structureproms",
  ...
  },
  {
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "token",
            "description": "<p>The token obtained after the call to RequestApproval method</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
          ...
          },
          {
            ...
            "optional": false,
            "field": "deviceId",
            "description": "<p>The ID of the user device</p>"
          }
        ]
      }
    },
        ...
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "status",
            "description": "<p>{status:requestStatus} The request status could be:</p> <ul> <li>approved</li> <li>pending</li> <li>denied</li> </ul>"
          }
        ],
        "Failed 400": [
          {
            ...
            "optional": false,
            "field": "Information",
            "description": "<p>about the request was failed: 'Bad Request.'</p>"
          }
        ],
        "Failed 500": [
          {
            ...
            "optional": false,
            "field": "Error",
            "description": "<p>with the user. {message:'User not found'}</p>"
          }
        ]
      },
      "examples": [
    ...
    "filename": "controllers/all/user.js",
    "groupTitle": "SignIn_2FA"
  },
  {
    "type": "post",
    "url": "https://health29.org/api/api/signin/requestApproval",
    "title": "Request Authy approval",
    "name": "Request_approval",
    "version": "1.0.0",
    "group": "SignIn_2FA",
    "description": "<p>This method gets the token and the response for the request approval to Authy for a user. <br> <br> You will have to use the function <a href=\"#api-SignIn_2FA-Check_status_2FA\">Check status 2FA</a> <br> <br> We use the <a href=\"https://www.npmjs.com/package/fingerprintjs2\" target=\"_blank\">fingerprintjs2 library</a> for configuring the params.</p>",
    "examples": [
      {
        "title": "Example usage",
        "content": " var params=\"aa@aa.com\";\n this.http.post('https://health29.org/api/signin/requestApproval/'+params,this.deviceInformation)\n .subscribe( (res : any) => {\n\t\tif(res.type==\"2FA approved\"){\n\t\t\t// In this case the application has been correctly sent to Authy. Now, to continue, you must use the status2FA method described in \"SignIn 2FA\" section to check the user's response.\n\t\t\t// The login is not yet complete since Authy authorization is required by the user.\n\t\t}\n\t\telse{\n\t\t\tthis.isloggedIn = false;\n\t\t}\n });",
        "type": "js"
      },
      {
        "title": "Obtain device id and information.",
        ...
        "body": [
          {
            ...
            "optional": false,
            "field": "device",
            "description": "<p>Device information: timezone, platform and user Agent of the user device.</p>"
          }
        ]
      },
      "examples": [
        ...
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "message",
            "description": "<p>If all goes well, the system should return &quot;2FA approved&quot; and the token.</p>"
          },
          {
            "group": "Success 200",
            "type": "String",
            "optional": false,
            "field": "type",
            "description": "<p>The type param of the request indicate you if the request of send approval to authy is done correctly.</p>"
          },
          {
            "group": "Success 200",
            "type": "String",
            "optional": false,
            "field": "token",
            "description": "<p>You will need this <strong>token</strong> for review the request status from Authy.</p>"
          }
        ],
        "Failed 400": [
          {
            ...
            "optional": false,
            "field": "string",
            "description": "<p>Information about the request was failed: Bad Request sending approval</p>"
          }
        ]
      },
      "examples": [
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "token",
            "description": "<p>You will need this <strong>token</strong> in the header of all requests to the API functions for Authy.</p>"
          }
        ],
        "Failed 400": [
          {
  ...
  {
    "type": "post",
    "url": "https://health29.org/api/api/signin/isLogged2FA",
    "title": "Check 2FA login",
    "name": "isLogged2FA",
    "version": "1.0.0",
    "group": "SignIn_2FA",
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "Example usage:",
        "content": "var socialInfo = {education: '', completedEducation: '', currentEducation: '', work: '', hoursWork: '', profession: '', livingSituation: '', support: [], sports: [], interests: []};\nthis.http.post('https://health29.org/api/socialinfos/'+patientId, socialInfo)\n .subscribe( (res : any) => {\n   console.log('social info: '+ res.socialInfo);\n  }, (err) => {\n   ...\n  }",
        "type": "js"
      }
    ],
    "header": {
