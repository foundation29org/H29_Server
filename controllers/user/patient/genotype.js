...
/**
 * @api {delete} https://health29.org/api/clinicaltrial/:clinicalTrialId Delete Genotype
 * @apiName deleteGenotype
 * @apiDescription This method deletes a Genotype of a patient
 * @apiGroup Genotype
 * @apiVersion 1.0.0
 * @apiExample {js} Example usage:
 *   this.http.delete('https://health29.org/api/genotypes/'+genotypeId)
 *    .subscribe( (res : any) => {
 ...
 *       "authorization": "Bearer eyJ0eXAiOiJKV1QiLCJhbGciPgDIUzI1NiJ9.eyJzdWIiOiI1M2ZlYWQ3YjY1YjM0ZTQ0MGE4YzRhNmUyMzVhNDFjNjEyOThiMWZjYTZjMjXkZTUxMTA9OGVkN2NlODMxYWY3IiwiaWF0IjoxNTIwMzUzMDMwLCJlcHAiOjE1NTE4ODkwMzAsInJvbGUiOiJVc2VyIiwiZ3JvdDEiOiJEdWNoZW5uZSBQYXJlbnQgUHJfrmVjdCBOZXRoZXJsYW5kcyJ9.MloW8eeJ857FY7-vwxJaMDajFmmVStGDcnfHfGJx05k"
 *     }
 * @apiParam {String} genotypeId Genotype unique ID.
 * @apiSuccess {String} message If the clinicaltrial has been deleted correctly, it returns the message 'The genotype has been eliminated'.
 * @apiSuccessExample Success-Response:
 * HTTP/1.1 200 OK
 * {
